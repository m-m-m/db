...
public interface ModelSynchronizer {
  ...
  /**
   * Synchronizes all {@link EntityBean}s managed by a {@link io.github.mmm.db.repository.EntityRepository
   ...
   * @throws RuntimeException if no transaction is open for the according {@link io.github.mmm.db.source.DbSource
   *         database source}.
   */
