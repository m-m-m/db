...
import io.github.mmm.db.statement.ValuesClause;
 ...
 * @since 1.0.0
 */
public class UpdateSetClause<E extends EntityBean> extends SetClause<E, UpdateSetClause<E>> implements DbMainClause<E> {
