...
/**
 * {@link DbTypedClause} that can be an ending {@link DbClause} of an SQL {@link DbStatement} and allows to
 * {@link #get() get} the resulting {@link DbStatement}.
 *
 * @param <E> type of this {@link DbClause} (typically the {@link AbstractEntityClause#getEntity() entity}).
 * @since 1.0.0
 */
public interface DbMainClause<E> extends DbTypedClause<E>, DbClauseWithStatement {
