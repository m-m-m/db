...
class CreateIndexTest extends DbStatementTest {
  ...
  void testSingleColumn() {
    ...
    Song s = Song.of();
    // act
    CreateIndexStatement<Song> createIndexStatement = DbStatement.createIndex("IDX_GENRE").on(s).column(s.Genre())
        .get();
    // assert
  ...
  void testMultipleColumns() {
    ...
    Song s = Song.of();
    // act
    CreateIndexStatement<Song> createIndexStatement = DbStatement.createIndex("IDX_GENRE").on(s).as("S")
