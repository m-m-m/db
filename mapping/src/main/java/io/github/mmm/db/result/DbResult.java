...
package io.github.mmm.db.result;

import java.util.Iterator;

import io.github.mmm.base.exception.ObjectNotFoundException;
import io.github.mmm.db.result.impl.DbResultValueIterator;

/**
 * A {@link DbResult} represents a single result (row) from a database (typically of a select statement). It is an
 * abstraction of a JDBC {@link java.sql.ResultSet}.<br>
 *
 * @since 1.0.0
 * @see DbResultValue
 */
