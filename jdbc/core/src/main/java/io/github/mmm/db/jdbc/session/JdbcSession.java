...
package io.github.mmm.db.jdbc.session;

import java.sql.Connection;
import java.sql.SQLException;
import java.util.concurrent.Callable;

import io.github.mmm.db.jdbc.connection.JdbcConnection;
import io.github.mmm.db.jdbc.tx.JdbcTransactionExecutor;
import io.github.mmm.db.pool.DbConnectionData;
...
public class JdbcSession extends AbstractDbSession implements DbTransaction {
  ...
  public boolean isReadOnly() {
    ...
    return this.jdbcConnection.isReadOnly();
  }
