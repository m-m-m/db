...
image:https://img.shields.io/github/license/m-m-m/orm.svg?label=License["Apache License, Version 2.0",link=https://github.com/m-m-m/orm/blob/main/LICENSE]
...
image:https://javadoc.io/badge2/io.github.m-m-m/mmm-orm/javadoc.svg["JavaDoc",link=https://javadoc.io/doc/io.github.m-m-m/mmm-orm]
