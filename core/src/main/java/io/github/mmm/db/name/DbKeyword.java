...
public interface DbKeyword {
  ...
  Set<String> ALL_KEYWORDS = Set.of(ABORT, ABORTSESSION, ABS, ABSENT, ABSOLUTE, ACCESS, ACCESS_LOCK, ACCESSIBLE,
      ...
      COMPLETION, COMPRESS, COMPUTE, CONCAT, CONCURRENTLY, CONDITION, CONNECT, CONNECTION, CONSTRAINT, CONSTRAINTS,
      CONSTRUCTOR, CONTAINS, CONTAINSTABLE, CONTENT, CONTINUE, CONVERT, CONVERT_TABLE_HEADER, COPY, CORR, CORRESPONDING,
      COS, COSH, COUNT, COVAR_POP, COVAR_SAMP, CREATE, CROSS, CS, CSUM, CT, CUBE, CUME_DIST, CURRENT, CURRENT_CATALOG,
      CURRENT_DATE, CURRENT_DEFAULT_TRANSFORM_GROUP, CURRENT_LC_CTYPE, CURRENT_PATH, CURRENT_ROLE, CURRENT_ROW,
      CURRENT_SCHEMA, CURRENT_SERVER, CURRENT_TIME, CURRENT_TIMESTAMP, CURRENT_TIMEZONE,
      ...
      NEW_TABLE, NEXT, NEXTVAL, NO, NOAUDIT, NOCHECK, NOCOMPRESS, NONCLUSTERED, NONE, NORELY, NORMALIZE, NOT, NOTNULL,
      NOWAIT, NO_WRITE_TO_BINLOG, NTH_VALUE, NTILE, NULL, NULLABLE, NULLIF, NULLIFZERO, NULLS, NUMBER, NUMERIC,
