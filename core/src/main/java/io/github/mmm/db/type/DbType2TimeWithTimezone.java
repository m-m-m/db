...
/**
 * {@link DbType} with {@link #getTargetType() DB target type} of {@link Time} with timezone.
 *
 ...
 * @since 1.0.0
 */
public abstract class DbType2TimeWithTimezone<J, SELF extends DbType2TimeWithTimezone<J, SELF>>
    extends DbType2Time<J, SELF> {

  DbType2TimeWithTimezone(String name, Integer size, Integer scale, String format, String suffix,
